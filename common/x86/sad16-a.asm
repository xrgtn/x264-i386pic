...
%macro SAD_INC_1x16P_MMX 0 ; r0..r3
    movu    m1, [r0+ 0]
    movu    m2, [r0+ 8]
    movu    m3, [r0+16]
    movu    m4, [r0+24]
...
%macro SAD_INC_2x8P_MMX 0 ; r0..r3
    movu    m1, [r0+0]
    movu    m2, [r0+8]
    movu    m3, [r0+2*r1+0]
    movu    m4, [r0+2*r1+8]
...
%macro SAD_INC_2x4P_MMX 0 ; r0..r3
    movu    m1, [r0]
    movu    m2, [r0+2*r1]
    psubw   m1, [r2]
    psubw   m2, [r2+2*r3]
...
%macro SAD_X3_ONE_START 0 ; r0..r3
    mova    m3, [r0]
    movu    m0, [r1]
    movu    m1, [r2]
    movu    m2, [r3]
...
%macro SAD_X3_END 2 ; r0*, r5*, r5mp*, PIC*, RET
%if mmsize == 8 && %1*%2 == 256
    HADDUW   m0, m3
    HADDUW   m1, m4
    HADDUW   m2, m5
%else
    %if cpuflag(xop) && sizeof%[m0] == 16
        HADDW    m0, m3
        HADDW    m1, m4
        HADDW    m2, m5
    %else
...
%macro SAD_X4_ONE_START 0 ; r0..r4
    mova    m4, [r0]
    movu    m0, [r1]
    movu    m1, [r2]
    movu    m2, [r3]
...
%macro SAD_X4_END 2 ; r0, r6mp, PIC*, RET
%if mmsize == 8 && %1*%2 == 256
    HADDUW    m0, m4
    HADDUW    m1, m5
    HADDUW    m2, m6
...
%macro SAD_X_2xNP 4 ; r0..r4*
    %assign x %3
%rep %4
    SAD_X%1_ONE x*mmsize, x*mmsize ; X3: r0..r3 / X4: r0..r4
...
.end:
%if BIT_DEPTH == 9
    HADDW     m0, m1 ; max sum: 62(pixel diffs)*511(pixel_max)=31682 ; PIC*
%else
...
cglobal pixel_sad_x%1_%2x%3, 6,7,XMM_REGS
    ...
    mov     r6, %3/2-1
    SAD_X%1_ONE_START ; r0..r4*
    SAD_X%1_ONE 2*FENC_STRIDE, 2*STRIDE ; r0..r4*
    SAD_X_2xNP %1, STRIDE, 1, %2/(mmsize/2)-1 ; r0..r4*
.loop:
    SAD_X%1_INC_P ; r0..r5*
...
%if %1 == 4
    mov     r6, r6m
%endif
    SAD_X%1_END %2, %3 ; r0*, r5*, r6*, r5mp*, r6mp*, PIC*, RET
%endmacro
...
%macro INTRA_SAD_HVDC_ITER_YMM 2 ; r0
...
cglobal intra_sad_x3_8x8, 3,3,8
    ...
    vpbroadcastw   m0, xm0
    punpcklwd      m7, m7
    INTRA_SAD_HVDC_ITER_YMM 0, q3333 ; r0
